                ...
                <div class="w-full">
                    <div>
                        ...
                        <div class="md:grid md:grid-cols-4 hover:bg-gray-50 md:space-y-0 space-y-1 p-4 border-b">
                            ...
                            <p class="col-span-3">
                                {{$kemahasiswaan->alamat_direktori}}
                            </p>
                        </div>
                        <div class="md:grid md:grid-cols-4 hover:bg-gray-50 md:space-y-0 space-y-1 p-4 border-b">
                            <p class="text-gray-600 col-span-1">
                    ...
                    <div class="p-4">
                        <a href="{{route('kemahasiswaans.index')}}"
                        ...
                        <a href="{{route('kemahasiswaans.edit', $kemahasiswaan->id)}}"
