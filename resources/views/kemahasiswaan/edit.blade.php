<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 my-10">
        <!-- Form -->
        <form class="bg-white p-5 rounded-md" action="{{route('kemahasiswaans.update', $kemahasiswaan->id)}}" method="POST">
            @csrf
            @method('PUT')
            <div class="grid gap-2 lg:gap-5">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                    <div>
                        ...
                        <input type="text" name="alamat_monev" id="alamat_monev"
                               value="{{$kemahasiswaan->alamat_monev}}"
                               class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="alamat_direktori" id="alamat_direktori"
                               value="{{$kemahasiswaan->alamat_direktori}}"
                               class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                    <div>
                        ...
                        <input type="text" name="alamat_pddikti" id="alamat_pddikti"
                               value="{{$kemahasiswaan->alamat_pddikti}}"
                               class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_monev" id="tanggal_monev"
                               value="{{\Carbon\Carbon::parse($kemahasiswaan->tanggal_monev)->format('Y-m-d')}}"
                               class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea id="permasalahan" name="permasalahan" rows="4"
                        ...
                        {{ trim($kemahasiswaan->permasalahan) }}
                    </textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="hasil_monev" id="hasil_monev"
                           value="{{$kemahasiswaan->hasil_monev}}"
                           class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                </div>
            </div>
            <!-- End Grid -->
            ...
            <div class="mt-5">
                <a href="{{route('kemahasiswaans.show', $kemahasiswaan->id)}}"
