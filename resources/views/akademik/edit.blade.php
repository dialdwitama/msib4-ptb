<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 my-10">
        <!-- Form -->
        <form class="bg-white p-5 rounded-md" action="{{route('akademiks.update', $akademik->id)}}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="alamat_direktori" id="alamat_direktori"
                               value="{{$akademik->alamat_direktori}}"
                               class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" name="tanggal_monev" id="tanggal_monev"
                               value="{{\Carbon\Carbon::parse($akademik->tanggal_monev)->format('Y-m-d')}}"
                               class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400">
                    </div>
                </div>
            ...
            <div class="mt-5">
                <a href="{{route('akademiks.show', $akademik->id)}}"
