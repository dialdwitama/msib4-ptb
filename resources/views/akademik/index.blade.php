                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div>
                                        <div class="inline-flex gap-x-2">
                                            <div>
                                                <div class="relative">
                                                    <form action="{{route('akademiks.index')}}" method="GET">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left">
                                            <a class="group inline-flex items-center gap-x-2"
                                               href="{{route('akademiks.index', ['sort' => 'kode'])}}">
                                                <span
                                                    class="text-xs font-semibold uppercase tracking-wide text-gray-800 dark:text-gray-200">
                                                  Kode
                                                </span>
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left">
                                            <a class="group inline-flex items-center gap-x-2"
                                               href="{{route('akademiks.index', ['sort' => 'nama_pt'])}}">
                                                <span
                                                    class="text-xs font-semibold uppercase tracking-wide text-gray-800 dark:text-gray-200">
                                        ...
                                        <th scope="col" class="px-6 py-3 text-left">
                                            <a class="group inline-flex items-center gap-x-2"
                                               href="{{route('akademiks.index', ['sort' => 'tanggal_monev'])}}">
                                                <span
                                                    class="text-xs font-semibold uppercase tracking-wide text-gray-800 dark:text-gray-200">
                                                  Tanggal Monev
                                                </span>
                                        ...
                                        <tr class="bg-white hover:bg-gray-50 dark:bg-slate-900 dark:hover:bg-slate-800">
                                            ...
                                            <td class="h-px w-px whitespace-nowrap">
                                                <a class="block relative z-10"
                                                   href="{{route('akademiks.show', $akademik->id)}}">
                                                    <div class="px-6 py-2">
                                                        <p class="text-sm text-gray-500">{{$akademik->kode}}</p>
                                                    </div>
                                                </a>
                                            </td>
                                            <td class="h-px w-px whitespace-nowrap">
                                            ...
                                            <td class="h-px w-px whitespace-nowrap">
                                                ...
                                                <a class="block relative z-10"
                                                   href="{{route('akademiks.show', $akademik->id)}}">
                                                    <div class="px-6 py-2">
                                                        <p class="text-sm text-gray-500">{{\Carbon\Carbon::make($akademik->tanggal_monev)->toDateString()}}</p>
                                                    </div>
                                                </a>
                                            </td>
                                                        ...
                                                        <div
                                                          ...
                                                          <span
                                                            ...
                                                            Aksi
                                                                ...
                                                                <a class="flex items-center gap-x-3 py-2 px-3 rounded-md text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                                                                   href="{{route('akademiks.edit', $akademik->id)}}">
                                                                    Edit
                                                                </a>
                                                            </div>
                                                            <div class="py-2 first:pt-0 last:pb-0">
                                                                <form action="{{route('akademiks.destroy', $akademik->id)}}"
                                                                      method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type="submit"
                                ...
                                <div
                                    ...
                                    <div>
                                        <p class="text-sm text-gray-600 dark:text-gray-400">
                                            <span
                                                class="font-semibold text-gray-800 dark:text-gray-200">{{$akademiks->count()}}</span>
                                            results
                                        </p>
                                    </div>
